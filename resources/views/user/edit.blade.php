                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control noborder" id="select" name="title">
                                        ...
                                        <option value="prof." {{ ($user->title == "prof.") ? 'selected' : ''}}>prof.
                                        </option>
                                        <option value="nema titule" {{ ($user->title == "nema titule") ? 'selected' : ''}}>
                                            Nema
                                            titule
                                        </option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control noborder" id="select" name="type">
                                        ...
                                        <option value="professor" {{ ($user->type == "professor") ? 'selected' : ''}}>
                                            Profesor
                                        </option>
                                        <option value="student" {{ ($user->type == "student") ? 'selected' : ''}}>
                                            Student
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control noborder" id="select" name="is_active">
                                        <option value="1" {{ ($user->is_active == 1) ? 'selected' : ''}}>Aktivan
                                        </option>
                                        <option value="0" {{ ($user->is_active == 0) ? 'selected' : ''}}>Neaktivan
                                        </option>
                                    </select>
                                </div>
                            </div>@endcan
