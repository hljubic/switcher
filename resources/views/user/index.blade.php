    ...
    <div class="col-md-8 col-md-offset-2">
        <div id="page-content-wrapper" class="panel-default" style="margin-top: 50px;">
            <ul class="nav nav-pills nav-justified" style=" border: 3px;">
                ...
                <li><a href="{{route('user_create')}}" class="btn">Dodaj</a></li>
            </ul>
                    ...
                    <table class="table table-striped table-hover ">
                        ...
                        @foreach($users as $user)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('user_edit')}}/{{$user->id}}"
                                       class="btn btn-primary btn-xs">Uredi</a></td>
                                <td><a href="{{route('user_delete')}}/{{$user->id}}" class="btn btn-danger btn-xs">Izbriši</a>
                                </td>
                            </tr>
