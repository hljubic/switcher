...
@section('content')
    ...
    <div class="col-md-8 col-md-offset-2">
        <form class="form-horizontal" action="{{ route('studies') }}/edit/{{$studies->id}}" method="POST">
            {{method_field("PATCH")}}
            {{csrf_field()}}
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="inputName" name="name" placeholder="Naziv studija" value="{{$studies->name}}">
                    </div>
                </div>
                <div class="form-group">
